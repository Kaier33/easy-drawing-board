    ...
    _createClass(Draw, [{
      ...
      value: function undo() {
        ...
        this.historyImage.onload = function () {
          ...
          _this2.context.drawImage(_this2.historyImage, 0, 0);
        };
      }
    }, {
      key: "setBackground",
      ...
      value: function handleMousemove() {
        ...
        return {
          ...
          straightLine: function straightLine(mousePosition) {
            ...
            _this3.context.moveTo(originX, originY);
          ...
          rect: function rect(mousePosition) {
            ...
            _this3.context.rect(newOriginX, newOriginY, distanceX, distanceY);
          ...
          circle: function circle(mousePosition) {
            ...
            _this3.reDraw(); // 根据狗股定理算出半径


            var r = Math.sqrt(distanceX * distanceX + distanceY * distanceY); // 确保鼠标在圆心位置(虽然只能保证左边)

            _this3.context.arc(newOriginX + distanceX, newOriginY + distanceY, r, 0, 2 * Math.PI);
          ...
          arrow: function arrow(mousePosition) {
            ...
            _this3.arrowPoints[1] = {
              x: x / _this3.canvasWidth,
              y: y / _this3.canvasHeight
            };
            drawArrow(_this3.context, {
              points: _this3.arrowPoints,
              arrowSize: _this3.configuration.arrowSize,
              canvasWidth: _this3.canvasWidth,
              canvasHeight: _this3.canvasHeight
            });
          },
          eraser: function eraser(mousePosition) {
            var x = mousePosition.x,
                y = mousePosition.y;
            _this3.bgImg ? _this3.context.globalCompositeOperation = "destination-out" : null;
            _this3.context.strokeStyle = _this3.configuration.canvasBgColor;
            _this3.context.fillStyle = _this3.configuration.canvasBgColor;
            _this3.context.lineWidth = _this3.configuration.eraserSize;
      ...
      value: function drawText(ctx, options) {
        ...
        string.replace(/<br>/g, "\n").split(/\n/).map(function (value, index) {
          ctx.fillText(value, options.position.x + 2, options.position.y + index * _this4.configuration.textLineHeight + _this4.configuration.textLineHeight / 2 + 2);
        });
        ctx.restore();
      }
    }, {
      ...
      value: function createTextArea(position) {
        ...
        this.textareaEl.onblur = function () {
          _this5.mode = null;
          Dom.delAttr(_this5.textareaEl, "autofocus");

          _this5.drawText(_this5.context, {
            text: _this5.textareaEl.value,
            position: position
          });

          Dom.removeChild(_this5.container, _this5.boxDom);
        };

        this.textareaEl.addEventListener("input", function (e) {
          _this5.measureEl.innerHTML = e.target.value + " ";
          _this5.textareaEl.style.width = _this5.measureEl.clientWidth + "px";
          _this5.textareaEl.style.height = _this5.measureEl.clientHeight + "px";
        });
      } // api
      ...
      //     const _data = this.canvas.toDataURL(`image/${type}`);
      ...
      //     const bgImg = await loadImg(this.bgImg);
      //     !bgImg && reject()
      //     _context.drawImage(bgImg, 0, 0, this.canvasWidth, this.canvasHeight);
      //     const painting = await loadImg(_data);
      //     !painting && reject()
      //     _context.drawImage(painting, 0, 0, this.canvasWidth, this.canvasHeight);
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 3;
                    return getBase64Data(_this6.canvas, _this6.bgImg, type);
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 5;
                  return getBase64Data(this.canvas, this.bgImg, options.type);
